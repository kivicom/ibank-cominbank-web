...
?>
        <div>
                    ...
                    if ($id) {
                        if (isset($_POST['delete']) && $_POST['delete'] == "1") {
                            ...
                            foreach ($data as $field => $value) {
                                ...
                                $query .= "`".$field."`='".htmlspecialchars($value, ENT_QUOTES)."',";
                            }
                            $query = trim($query, ",");
            ...
            foreach ($branches as $branch){
                $branch_name = $branch->{'name_'.$lang};
                $branch_address = $branch->{'address_'.$lang};
                $branch_city = $branch->{'city_name'};
                $branch_description = $branch->{'description_'.$lang};
