...
?>
    <div class="cabinet_operation_receipt">
        ...
        <div class="cabinet_operation_receipt__item">
            ...
            <span class="cabinet_operation_receipt__value">
                <div class="cabinet_operation_receipt__item">
                    <span class="cabinet_operation_receipt__field">{RECEIPT_STATUS_NCONTRCAT}</span>
                    <span class="cabinet_operation_receipt__value"><?=$operation -> subject -> intrabankOperationSubject -> identifier?></span>
                </div>

                <div class="cabinet_operation_receipt__item">
                    <span class="cabinet_operation_receipt__field">{RECEIPT_STATUS_DEST_FIO}</span>
                    <span class="cabinet_operation_receipt__value"><?=$operation -> subject -> intrabankOperationSubject -> challengeResponseValue?></span>
                </div>
