...
IconSelect.COMPONENT_ICON_FILE_PATH = "/templates/jblank/js/libs/IconSelect/images/control/icon-select/arrow.png";
...
function IconSelect($$elementID, $$parameters) {
    ...
    this.setSelectedIndex = function($index){
        ...
        var eventChanged = document.createEvent("Event");
        eventChanged.initEvent("changed", true, true);
        _View.iconSelectElement.dispatchEvent(eventChanged);
