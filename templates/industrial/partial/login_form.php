...
$EXCEPTION = false;
$EXCEPTION_LIST = [
    'wrong_login_and_password_credentials' => 'Ошибка авторизации',
            ...
            if (isset($data['phone'])) {
                ...
                if ($IB->EXCEPTION) {
                    ...
                    if (isset($I18N[$trans])) {
                        ...
                        $EXCEPTION = $IB->EXCEPTION->errorDescription;
                        $IB->EXCEPTION = '';
                    }
                            ...
                            <div class="sub-services__acts">
                                <div class="client-input">
                                    <div class="client-input__data phone">
                                        ...
                                        <input id="phone" class="required" data-mask='phone' value="" type="text" placeholder="+38 (___) ___ __ __">
                                        <!--                                        <input name="args[0]" id="phone" value="+380955592879" type="text" placeholder="+38 (___) ___ __ __">-->
                        ...
                        <div class="load-apps">
                            ...
                            <span>
                                ...
                                <a href="#" target="_blank">
                                    <img src="templates/industrial/img/content/youtube.svg" width="24" height="24"  class="icons">
                                </a>
                            </span>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body preloader_block preloader_complete">
                    ...
                    <div class="preloader_content">
                        <form id="password_recovery_form" class="form-auth" action="" method="post">
                            <div class="sub-services__acts">
                                <div class="client-input">
                                    ...
                                    <div class="client-input__data">
                                        ...
                                        <input class="required" name="data[email]" value="" type="email"  />
                                    </div>
                                </div>
                                <button type="button" class="btn-press" onclick="password_recovery_send()">{LOGIN-FORM-RECOVERY}</button>
                            </div>
                        </form>
